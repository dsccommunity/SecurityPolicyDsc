...
$USR_Ensure    = New-xDscResourceProperty -Name Ensure -Type String -Attribute Required -ValidateSet 'Present','Absent' -Description "Specifies if the identities should be granted or removed from a user right assignment."
...
$URS = @{
    ...
    Property = $USR_Policy,$USR_Identity,$USR_Ensure,$USR_DesiredId
