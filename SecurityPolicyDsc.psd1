#
# Module manifest for module 'SeceditDSC'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('DesiredStateConfiguration', 'DSC', 'DSCResourceKit', 'DSCResource', 'Secedit')

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/PowerShell/SeceditDsc/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/PowerShell/SeceditDsc'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = '* SeceditDsc: Initial Release.'
